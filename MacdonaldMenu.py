...
#Database import from NorthSpineCanteenDatabase.py with method GetFoodORPrice() to get the menu's item and price
from NorthSpineCanteenDataBase import GetFoodORPrice

import datetime

class Ui_MacDonaldMenu(object):
      ...
      try:
        ...
        self.Output.setText("Error!")
         ...
         if inputValue<0:
             ...
             if hour >= 11 and hour <= 13 and day != "Sat" and day != "Sun":
    ...
    def showTime(self):
        ...
        if hour >= 6 and hour <=10:
            ...
            self.MCDLabel.setText("MacDonald's Breakfast Menu")
            self.InputBox.show()
            ...
            self.Item1.setText(GetFoodORPrice("NorthSpineCanteen", "MacDonald", "Breakfast",0))
            self.Item2.setText(GetFoodORPrice("NorthSpineCanteen", "MacDonald", "Breakfast",1))
            self.Item3.setText(GetFoodORPrice("NorthSpineCanteen", "MacDonald", "Breakfast",2))
            self.Item4.setText(GetFoodORPrice("NorthSpineCanteen", "MacDonald", "Breakfast",3))
            ...
            self.Price1.setText(GetFoodORPrice("PNorthSpineCanteen", "MacDonald", "Breakfast",0))
            self.Price2.setText(GetFoodORPrice("PNorthSpineCanteen", "MacDonald", "Breakfast",1))
            self.Price3.setText(GetFoodORPrice("PNorthSpineCanteen", "MacDonald", "Breakfast",2))
            self.Price4.setText(GetFoodORPrice("PNorthSpineCanteen", "MacDonald", "Breakfast",3))
        ...
        #Display Weekday Lunch/Dinner Menu 
            ...
            self.NorthSpineCanteen.setText("North Spine Canteen")
            self.MCDLabel.setText("MacDonald's Lunch/Dinner Menu")
            self.InputBox.show()
            self.InputLabel.show()
            self.OutputLabel.show()
            self.Output.show()
            ...
            self.Price6.show()
            #Displaying the menu's item using the methods imported from the database            
            self.Item1.setText(GetFoodORPrice("NorthSpineCanteen", "MacDonald", "Lunch",0))
            self.Item2.setText(GetFoodORPrice("NorthSpineCanteen", "MacDonald", "Lunch",1))
            self.Item3.setText(GetFoodORPrice("NorthSpineCanteen", "MacDonald", "Lunch",2))
            self.Item4.setText(GetFoodORPrice("NorthSpineCanteen", "MacDonald", "Lunch",3))
            self.Item1.setGeometry(QtCore.QRect(80, 210, 221, 35))
            self.Item2.setGeometry(QtCore.QRect(80, 270, 221, 35))
            self.Item3.setGeometry(QtCore.QRect(80, 330, 221, 35))
            self.Item4.setGeometry(QtCore.QRect(80, 390, 221, 35))
            ...
            self.Item6.hide()
            #Displaying the item's price using the methods imported from the database
            self.Price1.setText(GetFoodORPrice("PNorthSpineCanteen", "MacDonald", "Lunch",0))
            self.Price2.setText(GetFoodORPrice("PNorthSpineCanteen", "MacDonald", "Lunch",1))
            self.Price3.setText(GetFoodORPrice("PNorthSpineCanteen", "MacDonald", "Lunch",2))
            self.Price4.setText(GetFoodORPrice("PNorthSpineCanteen", "MacDonald", "Lunch",3))
            self.Price1.setGeometry(QtCore.QRect(320, 210, 131, 35))
            self.Price2.setGeometry(QtCore.QRect(320, 270, 131, 35))
            self.Price3.setGeometry(QtCore.QRect(320, 330, 131, 35))
            self.Price4.setGeometry(QtCore.QRect(320, 390, 131, 35))
        ...
        #Display Weekend Lunch/Dinner Menu 
            ...
            self.Item3.setText(GetFoodORPrice("NorthSpineCanteen", "MacDonald", "Lunch",2))
            self.Item4.setText(GetFoodORPrice("NorthSpineCanteen", "MacDonald", "Lunch",3))
            self.Item5.setText(GetFoodORPrice("NorthSpineCanteen", "MacDonald", "Lunch",4))
            self.Item6.setText(GetFoodORPrice("NorthSpineCanteen", "MacDonald", "Lunch",5))
        ...
        #Displaying the item's price using the methods imported from the database
            ...
            self.Price3.setText(GetFoodORPrice("PNorthSpineCanteen", "MacDonald", "Lunch",2))
            self.Price4.setText(GetFoodORPrice("PNorthSpineCanteen", "MacDonald", "Lunch",3))
            self.Price5.setText(GetFoodORPrice("PNorthSpineCanteen", "MacDonald", "Lunch",4))
            self.Price6.setText(GetFoodORPrice("PNorthSpineCanteen", "MacDonald", "Lunch",5))
        ...
        #Display Restaurant is close
            ...
            self.MCDLabel.setText("MacDonald's Menu")
            self.InputBox.hide()
    ...
    def setupUi(self, MacDonaldMenu):
        MacDonaldMenu.setObjectName("MacDonaldMenu")
        MacDonaldMenu.resize(540, 555)
        MacDonaldMenu.setStyleSheet("background-color: rgb(58, 45, 37)")
        
        self.DayDateTimeLabel = QtWidgets.QLabel(MacDonaldMenu)
        ...
        self.NorthSpineCanteen = QtWidgets.QLabel(MacDonaldMenu)
        ...
        self.MCDLabel = QtWidgets.QLabel(MacDonaldMenu)
        self.MCDLabel.setGeometry(QtCore.QRect(10, 95, 521, 20))
        ...
        self.OperatingLabel = QtWidgets.QLabel(MacDonaldMenu)
        ...
        self.Item1 = QtWidgets.QLabel(MacDonaldMenu)
        ...
        self.Item2 = QtWidgets.QLabel(MacDonaldMenu)
        ...
        self.Item3 = QtWidgets.QLabel(MacDonaldMenu)
        ...
        self.Item4 = QtWidgets.QLabel(MacDonaldMenu)
        ...
        self.Item5 = QtWidgets.QLabel(MacDonaldMenu)
        ...
        self.Item6 = QtWidgets.QLabel(MacDonaldMenu)
        ...
        self.Price1 = QtWidgets.QLabel(MacDonaldMenu)
        ...
        self.Price2 = QtWidgets.QLabel(MacDonaldMenu)
        ...
        self.Price3 = QtWidgets.QLabel(MacDonaldMenu)
        ...
        self.Price4 = QtWidgets.QLabel(MacDonaldMenu)
        ...
        self.Price5 = QtWidgets.QLabel(MacDonaldMenu)
        ...
        self.Price6 = QtWidgets.QLabel(MacDonaldMenu)
        ...
        self.InputLabel = QtWidgets.QLabel(MacDonaldMenu)
        ...
        self.InputBox = QtWidgets.QLineEdit(MacDonaldMenu)
        ...
        self.OutputLabel = QtWidgets.QLabel(MacDonaldMenu)
        ...
        self.Output = QtWidgets.QLabel(MacDonaldMenu)
        ...
        self.CalculateButton = QtWidgets.QPushButton(MacDonaldMenu)
        ...
        self.BackButton = QtWidgets.QPushButton(MacDonaldMenu)
        ...
        self.BackButton.clicked.connect(MacDonaldMenu.close)
        #Upon clicked, close this interface

        timer = QTimer(MacDonaldMenu)
        timer.timeout.connect(self.showTime)
        timer.start(1000)
        self.showTime()
        #Timer used to update and execute the time methood every 1s
        
        self.retranslateUi(MacDonaldMenu)
        QtCore.QMetaObject.connectSlotsByName(MacDonaldMenu)
    
    def retranslateUi(self, MacDonaldMenu):
        _translate = QtCore.QCoreApplication.translate
        MacDonaldMenu.setWindowTitle(_translate("MacDonaldMenu", "MacDonald's Menu"))
        self.NorthSpineCanteen.setText(_translate("MacDonaldMenu", "North Spine Canteen"))
        self.MCDLabel.setText(_translate("MacDonaldMenu", "MacDonald's Menu"))
        self.OperatingLabel.setText(_translate("MacDonaldMenu", "Operating Hours: 6AM-11PM Daily \n Breakfast: 6AM-11AM  Lunch: 11AM-11PM \n Peak Hours: 11AM - 2PM \n Special Menu: SAT,SUN"))

        self.InputLabel.setText(_translate("MacDonaldMenu", "Input Customer in Queue:"))
        self.OutputLabel.setText(_translate("MacDonaldMenu", "Estimated Waiting Time:"))
        self.CalculateButton.setText(_translate("MacDonaldMenu", "Calculate"))
        self.BackButton.setText(_translate("MacDonaldMenu", "Back"))

if __name__ == "__main__":
    import sys
    app = QtWidgets.QApplication(sys.argv)
    MacDonaldMenu = QtWidgets.QDialog()
    ui = Ui_MacDonaldMenu()
    ui.setupUi(MacDonaldMenu)
    MacDonaldMenu.show()
    sys.exit(app.exec_())
