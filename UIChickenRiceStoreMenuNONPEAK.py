...
class Ui_UIChickenRiceStoreMenuNONPEAK(object):
    ...
    def setupUi(self, UIChickenRiceStoreMenuNONPEAK):
        UIChickenRiceStoreMenuNONPEAK.setObjectName("UIChickenRiceStoreMenuNONPEAK")
        UIChickenRiceStoreMenuNONPEAK.resize(540, 555)
        UIChickenRiceStoreMenuNONPEAK.setStyleSheet("background-color: rgb(58, 45, 37)")

        self.NorthSpineCanteen = QtWidgets.QLabel(UIChickenRiceStoreMenuNONPEAK)
        ...
        self.ChickenRiceLabel = QtWidgets.QLabel(UIChickenRiceStoreMenuNONPEAK)
        ...
        self.OperatingLabel = QtWidgets.QLabel(UIChickenRiceStoreMenuNONPEAK)
        ...
        self.Item1 = QtWidgets.QLabel(UIChickenRiceStoreMenuNONPEAK)
        ...
        self.Item2 = QtWidgets.QLabel(UIChickenRiceStoreMenuNONPEAK)
        ...
        self.Item3 = QtWidgets.QLabel(UIChickenRiceStoreMenuNONPEAK)
        ...
        self.Item4 = QtWidgets.QLabel(UIChickenRiceStoreMenuNONPEAK)
        ...
        self.Price1 = QtWidgets.QLabel(UIChickenRiceStoreMenuNONPEAK)
        ...
        self.Price2 = QtWidgets.QLabel(UIChickenRiceStoreMenuNONPEAK)
        ...
        self.Price3 = QtWidgets.QLabel(UIChickenRiceStoreMenuNONPEAK)
        ...
        self.Price4 = QtWidgets.QLabel(UIChickenRiceStoreMenuNONPEAK)
        ...
        self.InputLabel = QtWidgets.QLabel(UIChickenRiceStoreMenuNONPEAK)
        ...
        self.InputBox = QtWidgets.QLineEdit(UIChickenRiceStoreMenuNONPEAK)
        ...
        self.OutputLabel = QtWidgets.QLabel(UIChickenRiceStoreMenuNONPEAK)
        ...
        self.OutputBox = QtWidgets.QLabel(UIChickenRiceStoreMenuNONPEAK)
        ...
        self.CalculateButton = QtWidgets.QPushButton(UIChickenRiceStoreMenuNONPEAK)
        ...
        self.BackButton = QtWidgets.QPushButton(UIChickenRiceStoreMenuNONPEAK)
        ...
        self.BackButton.clicked.connect(UIChickenRiceStoreMenuNONPEAK.close)
        #Upon clicked, close this interface

        self.retranslateUi(UIChickenRiceStoreMenuNONPEAK)
        QtCore.QMetaObject.connectSlotsByName(UIChickenRiceStoreMenuNONPEAK)

    def retranslateUi(self, UIChickenRiceStoreMenuNONPEAK):
        _translate = QtCore.QCoreApplication.translate
        UIChickenRiceStoreMenuNONPEAK.setWindowTitle(_translate("UIChickenRiceStoreMenuNONPEAK", "ChickenRiceStore's Menu"))
        self.NorthSpineCanteen.setText(_translate("UIChickenRiceStoreMenuNONPEAK", "North Spine Canteen"))
        self.ChickenRiceLabel.setText(_translate("UIChickenRiceStoreMenuNONPEAK", "The Chicken Rice Store's Menu"))
        self.OperatingLabel.setText(_translate("UIChickenRiceStoreMenuNONPEAK", "Operating Hours: 9AM-8PM (MON-FRI) \n Peak Hours: 11AM - 2PM \n Special Menu: TUE,THU"))

        #Displaying the menu's item using the methods imported from the database
        self.Item1.setText(_translate("UIChickenRiceStoreMenuNONPEAK", GetFoodORPrice("NorthSpineCanteen","ChickenRiceStore","AllDay",0)))
        self.Item2.setText(_translate("UIChickenRiceStoreMenuNONPEAK", GetFoodORPrice("NorthSpineCanteen","ChickenRiceStore","AllDay",1)))
        self.Item3.setText(_translate("UIChickenRiceStoreMenuNONPEAK", GetFoodORPrice("NorthSpineCanteen","ChickenRiceStore","AllDay",2)))
        self.Item4.setText(_translate("UIChickenRiceStoreMenuNONPEAK", GetFoodORPrice("NorthSpineCanteen","ChickenRiceStore","AllDay",3)))
        #Displaying the item's price using the methods imported from the database
        self.Price1.setText(_translate("UIChickenRiceStoreMenuNONPEAK", GetFoodORPrice("PNorthSpineCanteen","ChickenRiceStore","AllDay",0)))
        self.Price2.setText(_translate("UIChickenRiceStoreMenuNONPEAK", GetFoodORPrice("PNorthSpineCanteen","ChickenRiceStore","AllDay",1)))
        self.Price3.setText(_translate("UIChickenRiceStoreMenuNONPEAK", GetFoodORPrice("PNorthSpineCanteen","ChickenRiceStore","AllDay",2)))
        self.Price4.setText(_translate("UIChickenRiceStoreMenuNONPEAK", GetFoodORPrice("PNorthSpineCanteen","ChickenRiceStore","AllDay",3)))

        self.InputLabel.setText(_translate("UIChickenRiceStoreMenuNONPEAK", "Input Customer in Queue:"))
        self.OutputLabel.setText(_translate("UIChickenRiceStoreMenuNONPEAK", "Estimated Waiting Time: "))
        self.CalculateButton.setText(_translate("UIChickenRiceStoreMenuNONPEAK", "Calculate"))
        self.BackButton.setText(_translate("UIChickenRiceStoreMenuNONPEAK", "Back"))

if __name__ == "__main__":
    import sys
    app = QtWidgets.QApplication(sys.argv)
    UIChickenRiceStoreMenuNONPEAK = QtWidgets.QDialog()
    ui = Ui_UIChickenRiceStoreMenuNONPEAK()
    ui.setupUi(UIChickenRiceStoreMenuNONPEAK)
    UIChickenRiceStoreMenuNONPEAK.show()
    sys.exit(app.exec_())
