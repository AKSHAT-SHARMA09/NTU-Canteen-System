...
class Ui_UISubwayMenuLunchNONPEAK(object):
    ...
    def setupUi(self, UISubwayMenuLunchNONPEAK):
        UISubwayMenuLunchNONPEAK.setObjectName("UISubwayMenuLunchNONPEAK")
        UISubwayMenuLunchNONPEAK.resize(540, 555)
        UISubwayMenuLunchNONPEAK.setStyleSheet("background-color: rgb(58, 45, 37)")

        self.NorthSpineCanteen = QtWidgets.QLabel(UISubwayMenuLunchNONPEAK)
        ...
        self.SUBLabel = QtWidgets.QLabel(UISubwayMenuLunchNONPEAK)
        self.SUBLabel.setGeometry(QtCore.QRect(70, 40, 421, 38))
        self.SUBLabel.setStyleSheet("color: rgb(236, 92, 42)")
        font = QtGui.QFont()
        font.setPointSize(12)
        font.setBold(True)
        font.setWeight(75)
        ...
        self.OperatingLabel = QtWidgets.QLabel(UISubwayMenuLunchNONPEAK)
        self.OperatingLabel.setGeometry(QtCore.QRect(120, 78, 330, 71))
        self.OperatingLabel.setStyleSheet("color: rgb(227, 158, 111)")
        font = QtGui.QFont()
        font.setPointSize(7)
        font.setBold(True)
        font.setWeight(75)
        ...
        self.Item1 = QtWidgets.QLabel(UISubwayMenuLunchNONPEAK)
        ...
        self.Item2 = QtWidgets.QLabel(UISubwayMenuLunchNONPEAK)
        ...
        self.Item3 = QtWidgets.QLabel(UISubwayMenuLunchNONPEAK)
        ...
        self.Item4 = QtWidgets.QLabel(UISubwayMenuLunchNONPEAK)
        ...
        self.Price1 = QtWidgets.QLabel(UISubwayMenuLunchNONPEAK)
        ...
        self.Price2 = QtWidgets.QLabel(UISubwayMenuLunchNONPEAK)
        ...
        self.Price3 = QtWidgets.QLabel(UISubwayMenuLunchNONPEAK)
        ...
        self.Price4 = QtWidgets.QLabel(UISubwayMenuLunchNONPEAK)
        ...
        self.InputLabel = QtWidgets.QLabel(UISubwayMenuLunchNONPEAK)
        ...
        self.InputBox = QtWidgets.QLineEdit(UISubwayMenuLunchNONPEAK)
        ...
        self.OutputLabel = QtWidgets.QLabel(UISubwayMenuLunchNONPEAK)
        ...
        self.OutputBox = QtWidgets.QLabel(UISubwayMenuLunchNONPEAK)
        ...
        self.CalculateButton = QtWidgets.QPushButton(UISubwayMenuLunchNONPEAK)
        ...
        self.BackButton = QtWidgets.QPushButton(UISubwayMenuLunchNONPEAK)
        ...
        self.BackButton.clicked.connect(UISubwayMenuLunchNONPEAK.close)
        #Upon clicked, close this interface

        self.retranslateUi(UISubwayMenuLunchNONPEAK)
        QtCore.QMetaObject.connectSlotsByName(UISubwayMenuLunchNONPEAK)

    def retranslateUi(self, UISubwayMenuLunchNONPEAK):
        _translate = QtCore.QCoreApplication.translate
        UISubwayMenuLunchNONPEAK.setWindowTitle(_translate("UISubwayMenuLunchNONPEAK", "Subway's Menu"))
        self.NorthSpineCanteen.setText(_translate("UISubwayMenuLunchNONPEAK", "North Spine Canteen"))
        self.SUBLabel.setText(_translate("UISubwayMenuLunchNONPEAK", "Subway's Lunch/Dinner Menu"))
        self.OperatingLabel.setText(_translate("UISubwayMenuLunchNONPEAK", "Operating Hours: 8AM - 11PM Daily \n Breakfast: 8AM - 11AM  Lunch/Dinner: 11AM - 11PM \n Peak Hours: 11AM - 2PM \n Special Menu: SAT,SUN"))

        #Displaying the menu's item using the methods imported from the database
        self.Item1.setText(_translate("UISubwayMenuLunchNONPEAK", GetFoodORPrice("NorthSpineCanteen","Subway","Lunch",0)))
        self.Item2.setText(_translate("UISubwayMenuLunchNONPEAK", GetFoodORPrice("NorthSpineCanteen","Subway","Lunch",1)))
        self.Item3.setText(_translate("UISubwayMenuLunchNONPEAK", GetFoodORPrice("NorthSpineCanteen","Subway","Lunch",2)))
        self.Item4.setText(_translate("UISubwayMenuLunchNONPEAK", GetFoodORPrice("NorthSpineCanteen","Subway","Lunch",3)))
        #Displaying the item's price using the methods imported from the database
        self.Price1.setText(_translate("UISubwayMenuLunchNONPEAK", GetFoodORPrice("PNorthSpineCanteen","Subway","Lunch",0)))
        self.Price2.setText(_translate("UISubwayMenuLunchNONPEAK", GetFoodORPrice("PNorthSpineCanteen","Subway","Lunch",1)))
        self.Price3.setText(_translate("UISubwayMenuLunchNONPEAK", GetFoodORPrice("PNorthSpineCanteen","Subway","Lunch",2)))
        self.Price4.setText(_translate("UISubwayMenuLunchNONPEAK", GetFoodORPrice("PNorthSpineCanteen","Subway","Lunch",3)))

        self.InputLabel.setText(_translate("UISubwayMenuLunchNONPEAK", "Input Customer in Queue:"))
        self.OutputLabel.setText(_translate("UISubwayMenuLunchNONPEAK", "Estimated Waiting Time:"))
        self.CalculateButton.setText(_translate("UISubwayMenuLunchNONPEAK", "Calculate"))
        self.BackButton.setText(_translate("UISubwayMenuLunchNONPEAK", "Back"))

if __name__ == "__main__":
    import sys
    app = QtWidgets.QApplication(sys.argv)
    UISubwayMenuLunchNONPEAK = QtWidgets.QDialog()
    ui = Ui_UISubwayMenuLunchNONPEAK()
    ui.setupUi(UISubwayMenuLunchNONPEAK)
    UISubwayMenuLunchNONPEAK.show()
    sys.exit(app.exec_())
