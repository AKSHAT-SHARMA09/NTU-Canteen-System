...
class Ui_UIChickenRiceStoreMenuSPECIAL(object):
    ...
    def setupUi(self, UIChickenRiceStoreMenuSPECIAL):
        UIChickenRiceStoreMenuSPECIAL.setObjectName("UIChickenRiceStoreMenuSPECIAL")
        UIChickenRiceStoreMenuSPECIAL.resize(540, 555)
        UIChickenRiceStoreMenuSPECIAL.setStyleSheet("background-color: rgb(58, 45, 37)")

        self.NorthSpineCanteen = QtWidgets.QLabel(UIChickenRiceStoreMenuSPECIAL)
        ...
        self.ChickenRiceLabel = QtWidgets.QLabel(UIChickenRiceStoreMenuSPECIAL)
        self.ChickenRiceLabel.setGeometry(QtCore.QRect(70, 40, 421, 38))
        ...
        self.ChickenRiceLabel.setObjectName("Chicken Rice Store's Special Menu")

        self.OperatingLabel = QtWidgets.QLabel(UIChickenRiceStoreMenuSPECIAL)
        self.OperatingLabel.setGeometry(QtCore.QRect(120, 78, 300, 50))
        ...
        self.Item1 = QtWidgets.QLabel(UIChickenRiceStoreMenuSPECIAL)
        ...
        self.Item2 = QtWidgets.QLabel(UIChickenRiceStoreMenuSPECIAL)
        ...
        self.Item3 = QtWidgets.QLabel(UIChickenRiceStoreMenuSPECIAL)
        ...
        self.Item4 = QtWidgets.QLabel(UIChickenRiceStoreMenuSPECIAL)
        ...
        self.Item5 = QtWidgets.QLabel(UIChickenRiceStoreMenuSPECIAL)
        ...
        self.Item6 = QtWidgets.QLabel(UIChickenRiceStoreMenuSPECIAL)
        ...
        self.Price1 = QtWidgets.QLabel(UIChickenRiceStoreMenuSPECIAL)
        ...
        self.Price2 = QtWidgets.QLabel(UIChickenRiceStoreMenuSPECIAL)
        ...
        self.Price3 = QtWidgets.QLabel(UIChickenRiceStoreMenuSPECIAL)
        self.Price3.setGeometry(QtCore.QRect(320, 230, 131, 41))
        ...
        self.Price4 = QtWidgets.QLabel(UIChickenRiceStoreMenuSPECIAL)
        ...
        self.Price5 = QtWidgets.QLabel(UIChickenRiceStoreMenuSPECIAL)
        ...
        self.Price6 = QtWidgets.QLabel(UIChickenRiceStoreMenuSPECIAL)
        ...
        self.InputLabel = QtWidgets.QLabel(UIChickenRiceStoreMenuSPECIAL)
        ...
        self.InputBox = QtWidgets.QLineEdit(UIChickenRiceStoreMenuSPECIAL)
        ...
        self.OutputLabel = QtWidgets.QLabel(UIChickenRiceStoreMenuSPECIAL)
        ...
        self.OutputBox = QtWidgets.QLabel(UIChickenRiceStoreMenuSPECIAL)
        ...
        self.CalculateButton = QtWidgets.QPushButton(UIChickenRiceStoreMenuSPECIAL)
        ...
        self.BackButton = QtWidgets.QPushButton(UIChickenRiceStoreMenuSPECIAL)
        ...
        self.BackButton.clicked.connect(UIChickenRiceStoreMenuSPECIAL.close)
        #Upon clicked, close this interface

        self.retranslateUi(UIChickenRiceStoreMenuSPECIAL)
        QtCore.QMetaObject.connectSlotsByName(UIChickenRiceStoreMenuSPECIAL)

    def retranslateUi(self, UIChickenRiceStoreMenuSPECIAL):
        _translate = QtCore.QCoreApplication.translate
        UIChickenRiceStoreMenuSPECIAL.setWindowTitle(_translate("UIChickenRiceStoreMenuSPECIAL", "ChickenRiceStore's Menu"))
        self.NorthSpineCanteen.setText(_translate("UIChickenRiceStoreMenuSPECIAL", "North Spine Canteen"))
        self.ChickenRiceLabel.setText(_translate("UIChickenRiceStoreMenuSPECIAL", "The Chicken Rice Store's Menu"))
        self.OperatingLabel.setText(_translate("UIChickenRiceStoreMenuSPECIAL", "Operating Hours: 9AM-8PM (MON-FRI) \n Peak Hours: 11AM - 2PM \n (Special Menu: TUE,THU)"))

        #Displaying the menu's item using the methods imported from the database
        self.Item1.setText(_translate("UIChickenRiceStoreMenuSPECIAL", GetFoodORPrice("NorthSpineCanteen","ChickenRiceStore","AllDay",0)))
        self.Item2.setText(_translate("UIChickenRiceStoreMenuSPECIAL", GetFoodORPrice("NorthSpineCanteen","ChickenRiceStore","AllDay",1)))
        self.Item3.setText(_translate("UIChickenRiceStoreMenuSPECIAL", GetFoodORPrice("NorthSpineCanteen","ChickenRiceStore","AllDay",2)))
        self.Item4.setText(_translate("UIChickenRiceStoreMenuSPECIAL", GetFoodORPrice("NorthSpineCanteen","ChickenRiceStore","AllDay",3)))
        self.Item5.setText(_translate("UIChickenRiceStoreMenuSPECIAL", GetFoodORPrice("NorthSpineCanteen","ChickenRiceStore","AllDay",4)))
        self.Item6.setText(_translate("UIChickenRiceStoreMenuSPECIAL", GetFoodORPrice("NorthSpineCanteen","ChickenRiceStore","AllDay",5)))
        #Displaying the item's price using the methods imported from the database
        self.Price1.setText(_translate("UIChickenRiceStoreMenuSPECIAL", GetFoodORPrice("PNorthSpineCanteen","ChickenRiceStore","AllDay",0)))
        self.Price2.setText(_translate("UIChickenRiceStoreMenuSPECIAL", GetFoodORPrice("PNorthSpineCanteen","ChickenRiceStore","AllDay",1)))
        self.Price3.setText(_translate("UIChickenRiceStoreMenuSPECIAL", GetFoodORPrice("PNorthSpineCanteen","ChickenRiceStore","AllDay",2)))
        self.Price4.setText(_translate("UIChickenRiceStoreMenuSPECIAL", GetFoodORPrice("PNorthSpineCanteen","ChickenRiceStore","AllDay",3)))
        self.Price5.setText(_translate("UIChickenRiceStoreMenuSPECIAL", GetFoodORPrice("PNorthSpineCanteen","ChickenRiceStore","AllDay",4)))
        self.Price6.setText(_translate("UIChickenRiceStoreMenuSPECIAL", GetFoodORPrice("PNorthSpineCanteen","ChickenRiceStore","AllDay",5)))

        self.InputLabel.setText(_translate("UIChickenRiceStoreMenuSPECIAL", "Input Customer in Queue:"))
        self.OutputLabel.setText(_translate("UIChickenRiceStoreMenuSPECIAL", "Estimated Waiting Time: "))
        self.CalculateButton.setText(_translate("UIChickenRiceStoreMenuSPECIAL", "Calculate"))
        self.BackButton.setText(_translate("UIChickenRiceStoreMenuSPECIAL", "Back"))

if __name__ == "__main__":
    import sys
    app = QtWidgets.QApplication(sys.argv)
    UIChickenRiceStoreMenuSPECIAL = QtWidgets.QDialog()
    ui = Ui_UIChickenRiceStoreMenuSPECIAL()
    ui.setupUi(UIChickenRiceStoreMenuSPECIAL)
    UIChickenRiceStoreMenuSPECIAL.show()
    sys.exit(app.exec_())
