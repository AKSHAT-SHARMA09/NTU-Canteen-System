...
class Ui_UIWesternFoodStoreMenuNONPEAK(object):
    ...
    def setupUi(self, UIWesternFoodStoreMenuNONPEAK):
        UIWesternFoodStoreMenuNONPEAK.setObjectName("UIWesternFoodStoreMenuNONPEAK")
        UIWesternFoodStoreMenuNONPEAK.resize(540, 555)
        UIWesternFoodStoreMenuNONPEAK.setStyleSheet("background-color: rgb(58, 45, 37)")

        self.NorthSpineCanteen = QtWidgets.QLabel(UIWesternFoodStoreMenuNONPEAK)
        ...
        self.WesternFoodLabel = QtWidgets.QLabel(UIWesternFoodStoreMenuNONPEAK)
        ...
        self.OperatingLabel = QtWidgets.QLabel(UIWesternFoodStoreMenuNONPEAK)
        ...
        self.Item1 = QtWidgets.QLabel(UIWesternFoodStoreMenuNONPEAK)
        ...
        self.Item2 = QtWidgets.QLabel(UIWesternFoodStoreMenuNONPEAK)
        ...
        self.Item3 = QtWidgets.QLabel(UIWesternFoodStoreMenuNONPEAK)
        ...
        self.Item4 = QtWidgets.QLabel(UIWesternFoodStoreMenuNONPEAK)
        ...
        self.Price1 = QtWidgets.QLabel(UIWesternFoodStoreMenuNONPEAK)
        ...
        self.Price2 = QtWidgets.QLabel(UIWesternFoodStoreMenuNONPEAK)
        ...
        self.Price3 = QtWidgets.QLabel(UIWesternFoodStoreMenuNONPEAK)
        ...
        self.Price4 = QtWidgets.QLabel(UIWesternFoodStoreMenuNONPEAK)
        ...
        self.InputLabel = QtWidgets.QLabel(UIWesternFoodStoreMenuNONPEAK)
        ...
        self.InputBox = QtWidgets.QLineEdit(UIWesternFoodStoreMenuNONPEAK)
        ...
        self.OutputLabel = QtWidgets.QLabel(UIWesternFoodStoreMenuNONPEAK)
        ...
        self.OutputBox = QtWidgets.QLabel(UIWesternFoodStoreMenuNONPEAK)
        ...
        self.CalculateButton = QtWidgets.QPushButton(UIWesternFoodStoreMenuNONPEAK)
        ...
        self.BackButton = QtWidgets.QPushButton(UIWesternFoodStoreMenuNONPEAK)
        ...
        self.BackButton.clicked.connect(UIWesternFoodStoreMenuNONPEAK.close)
        #Upon clicked, close this interface

        self.retranslateUi(UIWesternFoodStoreMenuNONPEAK)
        QtCore.QMetaObject.connectSlotsByName(UIWesternFoodStoreMenuNONPEAK)
...
if __name__ == "__main__":
    ...
    UIWesternFoodStoreMenuNONPEAK = QtWidgets.QDialog()
    ui = Ui_UIWesternFoodStoreMenuNONPEAK()
    ui.setupUi(UIWesternFoodStoreMenuNONPEAK)
    UIWesternFoodStoreMenuNONPEAK.show()
    sys.exit(app.exec_())
