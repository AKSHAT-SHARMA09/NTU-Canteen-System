...
class Ui_UISubwayMenuLunchPEAK(object):
    ...
    def setupUi(self, UISubwayMenuLunchPEAK):
        UISubwayMenuLunchPEAK.setObjectName("UISubwayMenuLunchPEAK")
        UISubwayMenuLunchPEAK.resize(540, 555)
        UISubwayMenuLunchPEAK.setStyleSheet("background-color: rgb(58, 45, 37)")

        self.NorthSpineCanteen = QtWidgets.QLabel(UISubwayMenuLunchPEAK)
        ...
        self.SUBLabel = QtWidgets.QLabel(UISubwayMenuLunchPEAK)
        ...
        self.OperatingLabel = QtWidgets.QLabel(UISubwayMenuLunchPEAK)
        ...
        self.Item1 = QtWidgets.QLabel(UISubwayMenuLunchPEAK)
        ...
        self.Item2 = QtWidgets.QLabel(UISubwayMenuLunchPEAK)
        ...
        self.Item3 = QtWidgets.QLabel(UISubwayMenuLunchPEAK)
        ...
        self.Item4 = QtWidgets.QLabel(UISubwayMenuLunchPEAK)
        ...
        self.Price1 = QtWidgets.QLabel(UISubwayMenuLunchPEAK)
        ...
        self.Price2 = QtWidgets.QLabel(UISubwayMenuLunchPEAK)
        ...
        self.Price3 = QtWidgets.QLabel(UISubwayMenuLunchPEAK)
        ...
        self.Price4 = QtWidgets.QLabel(UISubwayMenuLunchPEAK)
        ...
        self.InputLabel = QtWidgets.QLabel(UISubwayMenuLunchPEAK)
        ...
        self.InputBox = QtWidgets.QLineEdit(UISubwayMenuLunchPEAK)
        ...
        self.OutputLabel = QtWidgets.QLabel(UISubwayMenuLunchPEAK)
        ...
        self.OutputBox = QtWidgets.QLabel(UISubwayMenuLunchPEAK)
        ...
        self.CalculateButton = QtWidgets.QPushButton(UISubwayMenuLunchPEAK)
        ...
        self.BackButton = QtWidgets.QPushButton(UISubwayMenuLunchPEAK)
        ...
        self.BackButton.clicked.connect(UISubwayMenuLunchPEAK.close)
         #Upon clicked, close this interface

        self.retranslateUi(UISubwayMenuLunchPEAK)
        QtCore.QMetaObject.connectSlotsByName(UISubwayMenuLunchPEAK)

    def retranslateUi(self, UISubwayMenuLunchPEAK):
        _translate = QtCore.QCoreApplication.translate
        UISubwayMenuLunchPEAK.setWindowTitle(_translate("UISubwayMenuLunchPEAK", "Subway's Menu"))
        self.NorthSpineCanteen.setText(_translate("UISubwayMenuLunchPEAK", "North Spine Canteen"))
        self.SUBLabel.setText(_translate("UISubwayMenuLunchPEAK", "Subway's Lunch/Dinner Menu"))
        ...
        self.Item1.setText(_translate("UISubwayMenuLunchPEAK", GetFoodORPrice("NorthSpineCanteen","Subway","Lunch",0)))
        self.Item2.setText(_translate("UISubwayMenuLunchPEAK", GetFoodORPrice("NorthSpineCanteen","Subway","Lunch",1)))
        self.Item3.setText(_translate("UISubwayMenuLunchPEAK", GetFoodORPrice("NorthSpineCanteen","Subway","Lunch",2)))
        self.Item4.setText(_translate("UISubwayMenuLunchPEAK", GetFoodORPrice("NorthSpineCanteen","Subway","Lunch",3)))
        #Displaying the item's price using the methods imported from the database
        self.Price1.setText(_translate("UISubwayMenuLunchPEAK", GetFoodORPrice("PNorthSpineCanteen","Subway","Lunch",0)))
        self.Price2.setText(_translate("UISubwayMenuLunchPEAK", GetFoodORPrice("PNorthSpineCanteen","Subway","Lunch",1)))
        self.Price3.setText(_translate("UISubwayMenuLunchPEAK", GetFoodORPrice("PNorthSpineCanteen","Subway","Lunch",2)))
        self.Price4.setText(_translate("UISubwayMenuLunchPEAK", GetFoodORPrice("PNorthSpineCanteen","Subway","Lunch",3)))

        self.InputLabel.setText(_translate("UISubwayMenuLunchPEAK", "Input Customer in Queue:"))
        self.OutputLabel.setText(_translate("UISubwayMenuLunchPEAK", "Estimated Waiting Time:"))
        self.CalculateButton.setText(_translate("UISubwayMenuLunchPEAK", "Calculate"))
        self.BackButton.setText(_translate("UISubwayMenuLunchPEAK", "Back"))

if __name__ == "__main__":
    import sys
    app = QtWidgets.QApplication(sys.argv)
    UISubwayMenuLunchPEAK = QtWidgets.QDialog()
    ui = Ui_UISubwayMenuLunchPEAK()
    ui.setupUi(UISubwayMenuLunchPEAK)
    UISubwayMenuLunchPEAK.show()
    sys.exit(app.exec_())
