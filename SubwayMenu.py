...
class Ui_SubwayMenu(object):
    ...
    def showTime(self):
        ...
        if hour >= 8 and hour <= 10:
            ...
            self.Item1.setText(GetFoodORPrice("NorthSpineCanteen","Subway","Breakfast",0))
            self.Item2.setText(GetFoodORPrice("NorthSpineCanteen","Subway","Breakfast",1))
            self.Item3.setText(GetFoodORPrice("NorthSpineCanteen","Subway","Breakfast",2))
            self.Item4.setText(GetFoodORPrice("NorthSpineCanteen","Subway","Breakfast",3))
            ...
            self.Price1.setText(GetFoodORPrice("PNorthSpineCanteen","Subway","Breakfast",0))
            self.Price2.setText(GetFoodORPrice("PNorthSpineCanteen","Subway","Breakfast",1))
            self.Price3.setText(GetFoodORPrice("PNorthSpineCanteen","Subway","Breakfast",2))
            self.Price4.setText(GetFoodORPrice("PNorthSpineCanteen","Subway","Breakfast",3))
        ...
        #Display Weekday Lunch/Dinner Menu
            ...
            self.Price6.show()
            #Displaying the menu's item using the methods imported from the database
            self.Item1.setText(GetFoodORPrice("NorthSpineCanteen","Subway","Lunch",0))
            self.Item2.setText(GetFoodORPrice("NorthSpineCanteen","Subway","Lunch",1))
            self.Item3.setText(GetFoodORPrice("NorthSpineCanteen","Subway","Lunch",2))
            self.Item4.setText(GetFoodORPrice("NorthSpineCanteen","Subway","Lunch",3))
            self.Item1.setGeometry(QtCore.QRect(80, 210, 221, 35))
            self.Item2.setGeometry(QtCore.QRect(80, 270, 221, 35))
            self.Item3.setGeometry(QtCore.QRect(80, 330, 221, 35))
            self.Item4.setGeometry(QtCore.QRect(80, 390, 221, 35))
            ...
            self.Item6.hide()
            #Displaying the item's price using the methods imported from the database
            self.Price1.setText(GetFoodORPrice("PNorthSpineCanteen","Subway","Lunch",0))
            self.Price2.setText(GetFoodORPrice("PNorthSpineCanteen","Subway","Lunch",1))
            self.Price3.setText(GetFoodORPrice("PNorthSpineCanteen","Subway","Lunch",2))
            self.Price4.setText(GetFoodORPrice("PNorthSpineCanteen","Subway","Lunch",3))
            self.Price1.setGeometry(QtCore.QRect(320, 210, 131, 35))
            self.Price2.setGeometry(QtCore.QRect(320, 270, 131, 35))
            self.Price3.setGeometry(QtCore.QRect(320, 330, 131, 35))
            self.Price4.setGeometry(QtCore.QRect(320, 390, 131, 35))
        ...
        #Display Weekend Lunch/Dinner Menu 
            ...
            self.Item3.setText(GetFoodORPrice("NorthSpineCanteen", "Subway", "Lunch",2))
            self.Item4.setText(GetFoodORPrice("NorthSpineCanteen", "Subway", "Lunch",3))
            self.Item5.setText(GetFoodORPrice("NorthSpineCanteen", "Subway", "Lunch",4))
            self.Item6.setText(GetFoodORPrice("NorthSpineCanteen", "Subway", "Lunch",5))
            ...
            self.Price3.setText(GetFoodORPrice("PNorthSpineCanteen", "Subway", "Lunch",2))
            self.Price4.setText(GetFoodORPrice("PNorthSpineCanteen", "Subway", "Lunch",3))
            self.Price5.setText(GetFoodORPrice("PNorthSpineCanteen", "Subway", "Lunch",4))
            self.Price6.setText(GetFoodORPrice("PNorthSpineCanteen", "Subway", "Lunch",5))
    ...
    def setupUi(self, SubwayMenu):
        SubwayMenu.setObjectName("SubwayMenu")
        SubwayMenu.resize(540, 555)
        SubwayMenu.setStyleSheet("background-color: rgb(58, 45, 37)")
        
        self.DayDateTimeLabel = QtWidgets.QLabel(SubwayMenu)
        self.DayDateTimeLabel.setGeometry(QtCore.QRect(10, 5, 521, 61))
        ...
        self.NorthSpineCanteen = QtWidgets.QLabel(SubwayMenu)
        ...
        self.SUBLabel = QtWidgets.QLabel(SubwayMenu)
        self.SUBLabel.setGeometry(QtCore.QRect(10, 95, 521, 20))
        ...
        self.OperatingLabel = QtWidgets.QLabel(SubwayMenu)
        ...
        self.Item1 = QtWidgets.QLabel(SubwayMenu)
        ...
        self.Item2 = QtWidgets.QLabel(SubwayMenu)
        ...
        self.Item3 = QtWidgets.QLabel(SubwayMenu)
        ...
        self.Item4 = QtWidgets.QLabel(SubwayMenu)
        ...
        self.Item5 = QtWidgets.QLabel(SubwayMenu)
        ...
        self.Item6 = QtWidgets.QLabel(SubwayMenu)
        ...
        self.Price1 = QtWidgets.QLabel(SubwayMenu)
        ...
        self.Price2 = QtWidgets.QLabel(SubwayMenu)
        ...
        self.Price3 = QtWidgets.QLabel(SubwayMenu)
        ...
        self.Price4 = QtWidgets.QLabel(SubwayMenu)
        ...
        self.Price5 = QtWidgets.QLabel(SubwayMenu)
        ...
        self.Price6 = QtWidgets.QLabel(SubwayMenu)
        ...
        self.InputLabel = QtWidgets.QLabel(SubwayMenu)
        ...
        self.InputBox = QtWidgets.QLineEdit(SubwayMenu)
        ...
        self.OutputLabel = QtWidgets.QLabel(SubwayMenu)
        ...
        self.Output = QtWidgets.QLabel(SubwayMenu)
        ...
        self.CalculateButton = QtWidgets.QPushButton(SubwayMenu)
        ...
        self.BackButton = QtWidgets.QPushButton(SubwayMenu)
        ...
        self.BackButton.clicked.connect(SubwayMenu.close)
        #Upon clicked, close this interface
        
        timer = QTimer(SubwayMenu)
        timer.timeout.connect(self.showTime)
        timer.start(1000)
        self.showTime()
        #Timer used to update and execute the time methood every 1s
        
        self.retranslateUi(SubwayMenu)
        QtCore.QMetaObject.connectSlotsByName(SubwayMenu)
    
    def retranslateUi(self, SubwayMenu):
        _translate = QtCore.QCoreApplication.translate
        SubwayMenu.setWindowTitle(_translate("SubwayMenu", "Subway's Menu"))
        self.NorthSpineCanteen.setText(_translate("SubwayMenu", "North Spine Canteen"))
        self.SUBLabel.setText(_translate("SubwayMenu", "Subway's Menu"))
        self.OperatingLabel.setText(_translate("SubwayMenu", "Operating Hours: 8AM - 11PM Daily \n Breakfast: 8AM - 11AM  Lunch/Dinner: 11AM - 11PM \n Peak Hours: 11AM - 2PM \n Special Menu: SAT,SUN"))
            
        self.InputLabel.setText(_translate("SubwayMenu", "Input Customer in Queue:"))
        self.OutputLabel.setText(_translate("SubwayMenu", "Estimated Waiting Time:"))
        self.CalculateButton.setText(_translate("SubwayMenu", "Calculate"))
        self.BackButton.setText(_translate("SubwayMenu", "Back"))

if __name__ == "__main__":
    import sys
    app = QtWidgets.QApplication(sys.argv)
    SubwayMenu = QtWidgets.QDialog()
    ui = Ui_SubwayMenu()
    ui.setupUi(SubwayMenu)
    SubwayMenu.show()
    sys.exit(app.exec_())
